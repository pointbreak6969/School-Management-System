...
router.patch('/fee-structure/:id', updateFeeStructure);
router.patch('/fee-structure/:id', getFeeStructure);

// Billing routes
router.post("/generate-bill", generateMonthlyBill);
router.post("/bills/:billId/payment", recordPayment);
router.get("/bills/student/:studentId", getBillingSummary);
router.get("/bills/student/:studentId/pending", getPendingBills);
